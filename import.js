    ...
    try {
        ...
        for (const province of provinces) {
            ...
            if (dbprovinces.rows.length <= 0) {
                ...
                await client.query(
                    'INSERT INTO "Locations" ("Id", "Name", "ParentId","Address","NormalizedName","Status","Country","Level","Type") VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)',
                    [province.Id, province.Name, null, address, normalizedName, 6, "VN", 3, type]
                );
            }
            ...
            for (const district of districts) {
                ...
                if (dbDistrict) {
                    ...
                    await client.query(
                        'INSERT INTO "Locations" ("Id", "Name", "ParentId","Address","NormalizedName","Status","Country","Level","Type") VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)',
                        [id, district.Name, province.Id, address, normalizedName, 6, "VN", 4, type]
                    );
                }
                ...
                for (const ward of wards) {
                    ...
                    if (dbWard) {
                        ...
                        await client.query(
                            'INSERT INTO "Locations" ("Id", "Name", "ParentId","Address","NormalizedName","Status","Country","Level","Type") VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)',
                            [wardId, ward.Name, id, address, normalizedName, 5, "VN", 5, type]
                        );
                    }
                }
